...
import { Computer, Education, Experience, FamilyMember, Language, Learn, Org, Step2Props } from "@/lib/interface";
import Image from "next/legacy/image";

const fileTypes = ["PDF"];
const Application: FC<Step2Props> = ({ formData, setFormData, prevStep, submitForm, job }) => {
  ...
  const [orgEntries, setOrgEntries] = useState<Org[]>([{ orgName: "", orgType: "", orgCompletionDate: "" }]);
  const [learnEntries, setLearnEntries] = useState<Learn[]>([{ lName: "", lSource: "" }]);
  ...
  const [computerEntries, setComputerEntries] = useState<Computer[]>([{ computerName: "" }]);
  const [languageEntries, setLanguageEntries] = useState<Language[]>([
    { languageName: "", languageSpeak: "", languageRead: "" },
  ]);

  const handleSelectedReasonChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  const addEntry = (entryType: "family" | "education" | "org" | "learn" | "experience" | "computer" | "language") => {
    if (entryType === "family") {
      ...
      setEducationEntries([...educationEntries, { schoolName: "", studyMode: "", degree: "", completionDate: "" }]);
    } else if (entryType === "org") {
      setOrgEntries([...orgEntries, { orgName: "", orgType: "", orgCompletionDate: "" }]);
      ...
      setLanguageEntries([...languageEntries, { languageName: "", languageSpeak: "", languageRead: "" }]);
    }
  };
  const removeEntry = (
    entryType: "family" | "education" | "org" | "learn" | "experience" | "computer" | "language",
    ...
    if (entryType === "family" && familyMembers.length > 1) {
      ...
      const updatedExperienceEntries = experienceEntries.filter((_, i) => i !== index);
      ...
      const updatedComputerEntries = computerEntries.filter((_, i) => i !== index);
  ...
  const getEmptyFields = (formData: { [x: string]: any; mail: string }) => {
    return requiredFields.filter((field) => !formData[field] || (field === "mail" && !validateEmail(formData.mail)));
  };
  ...
  return (
    <div className={styles.gnewtonCareerBodyClass}>
      <div className="">
        ...
        <br />
        <div>
          *Бид ажилд орох өргөдөл гаргаж, шаардлага хангасан ажил горилогчдыг үндэс, угсаа, хэл, арьсны өнгө, нас, хүйс,
          нийгмийн гарал байдал, хөрөнгө чинээ, эрхэлсэн ажил, албан тушаал, шашин шүтлэг, үзэл бодол, хөгжлийн
          бэрхшээлтэй байдал зэргээр ялгаварлан гадуурхахгүйгээр ажилд орох боломжийг тэнцүү олгодог.
        </div>
        <br />
        <div>
          "БИД АЖИЛТНУУДДАА ӨРСӨЛДӨХҮЙЦ ЦАЛИН, УРАМШУУЛАЛ БОЛОН АЖИЛЛАХ ТААТАЙ ОРЧИН НӨХЦӨЛИЙГ САНАЛ БОЛГОДОГ НЬ
          ЧАДВАРЛАГ ХҮНИЙ НӨӨЦИЙГ ТАТАН, ТОГТВОР СУУРЬШИЛТАЙ АЖИЛЛУУЛАХ ҮНДЭС БОЛДОГ"
        </div>
        <br />
      </div>
      ...
      <form id="uploadForm" name="uploadForm" className={styles.gnewtonSectionClass}>
        <dl>
          ...
          <dd>
            <div className={styles.applicationFieldLabelClass}>
              ...
              <span className="gnewtonStar">
                <img src="https://d3leeb4r1qy96s.cloudfront.net/assets/star_5px.png" alt="*" />
              </span>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <input type="text" name="obog" value={formData.obog} onChange={handleChange} maxLength={30} required />
            </div>
          </dd>
          <dd>
            <div className={styles.applicationFieldLabelClass}>
          ...
          <dd>
            ...
            <div className={styles.applicationFieldInputClass}>
              <select id="married" name="married" value={formData.married} onChange={handleChange} title="Married">
                <option>-</option>
          ...
          <dd>
            ...
            <div className={styles.applicationFieldInputClass}>
              <select id="gender" name="gender" value={formData.gender} onChange={handleChange} title="Gender" required>
                <option value="">-</option>
          ...
          {educationEntries.map((edu, index) => (
            <div key={index} className="flex ">
              <div className="flex-1 custom-section relative max-w-[480px]">
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_education${index + 1}_1`}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_education${index + 1}_2`}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_education${index + 1}_3`}>
                      Зэрэг( Мэргэжил )
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_education${index + 1}_4`}>
                      Төгссөн огноо
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                {index != 0 && (
                  <button className="float-right" type="button" onClick={() => removeEntry("education", index)}>
                    <Image
        ...
        <dl>
          <dt className={styles.gnewtonSectionTitleClass}>Мэргэшсэн байдал / Сургалт /</dt>
          {orgEntries.map((org, index) => (
            <div key={index} className="flex ">
              <div className="flex-1 custom-section relative max-w-[480px]">
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_career${index + 1}_1`}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_career${index + 1}_2`}>
                      Чиглэл
                    </label>
                  </div>
                  <div className={styles.applicationFieldInputClass}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_career${index + 1}_3`}>
                ...
                {index != 0 && (
                  <button className="float-right" type="button" onClick={() => removeEntry("org", index)}>
                    <Image
                      src="https://d3leeb4r1qy96s.cloudfront.net/assets/img/delete-icon.svg"
                      width={28}
                      height={28}
        ...
        <dl>
          <dt className={styles.gnewtonSectionTitleClass}>Бие даан суралцсан байдал</dt>
          {learnEntries.map((lea, index) => (
            <div key={index} className="flex ">
              <div className="flex-1 custom-section relative max-w-[480px]">
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_learn${index + 1}_1`}>
                      Хичээлийн нэр
                    </label>
                  </div>
                  <div className={styles.applicationFieldInputClass}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`v_learn${index + 1}_2`}>
                      Эх сурвалж
                    </label>
                  </div>
                  <div className={styles.applicationFieldInputClass}>
                ...
                {index != 0 && (
                  <button className="float-right" type="button" onClick={() => removeEntry("learn", index)}>
                    <Image
                      src="https://d3leeb4r1qy96s.cloudfront.net/assets/img/delete-icon.svg"
                      width={28}
                      height={28}
        ...
        <dl>
          <dt className={styles.gnewtonSectionTitleClass}>Ажлын туршлага (Хамгийн сүүлийн туршлагаас эхлэн бичих)</dt>
          {experienceEntries.map((experience, index) => (
            <div key={index} className="flex ">
              <div className="flex-1 custom-section relative max-w-[480px]">
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`ex${index + 1}_1`}>
                      Компанийн нэр
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`ex${index + 1}_2`}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`ex${index + 1}_3`}>
                      Ажлын байрны нэр
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`ex${index + 1}_4`}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`ex${index + 1}_5`}>
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`ex${index + 1}_6`}>
                      Ажилласан хугацаа
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`ex${index + 1}_7`}>
                ...
                {index != 0 && (
                  <button className="float-right" type="button" onClick={() => removeEntry("experience", index)}>
                    <Image
                      src="https://d3leeb4r1qy96s.cloudfront.net/assets/img/delete-icon.svg"
                      width={28}
                      height={28}
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="font-normal normal-case" htmlFor="car_learn">
                CAT тоног төхөөрөмжтэй ажиллаж байсан туршлага, сурч мэдсэн зүйлс
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <input
        ...
        <dl>
          <dt className={styles.gnewtonSectionTitleClass}>Компьютерийн мэдлэг</dt>
          {computerEntries.map((com, index) => (
            <div key={index} className="flex ">
              <div className="flex-1 custom-section relative max-w-[480px]">
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`computer${index + 1}_1`}>
                ...
                {index != 0 && (
                  <button className="float-right" type="button" onClick={() => removeEntry("computer", index)}>
                    <Image
                      src="https://d3leeb4r1qy96s.cloudfront.net/assets/img/delete-icon.svg"
                      width={28}
                      height={28}
        ...
        <dl>
          <dt className={styles.gnewtonSectionTitleClass}>Гадаад хэлний мэдлэг</dt>
          {languageEntries.map((lang, index) => (
            <div key={index} className="flex ">
              <div className="flex-1 custom-section relative max-w-[480px]">
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`lg${index + 1}_1`}>
                      Гадаад хэл
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`lg${index + 1}_2`}>
                      Ярих чадвар
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`lg${index + 1}_3`}>
                      Бичих чадвар
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                {index != 0 && (
                  <button className="float-right" type="button" onClick={() => removeEntry("language", index)}>
                    <Image
                      src="https://d3leeb4r1qy96s.cloudfront.net/assets/img/delete-icon.svg"
                      width={28}
                      height={28}
        ...
        <dl>
          <dt className={styles.gnewtonSectionTitleClass}>Мэргэжлийн бусад ур чадвар</dt>
          <dd>
            <div className={styles.applicationFieldLabelClass}>
              <label className="font-normal normal-case" htmlFor="other_talent"></label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <textarea
                name="other_talent"
          ...
          <dd>
            <div className={styles.applicationFieldLabelClass}>
              <label className="font-normal normal-case" htmlFor="car_password_type">
                Ангилал
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="font-normal normal-case" htmlFor="career_skill1">
                Мэргэжлийн ур чадвараа өөрөө дүгнэн бичнэ үү (Өөрийн сонирхож буй ажлын байранд уялдуулан бичнэ үү)
              </label>
              <span className="gnewtonStar">
                <img src="https://d3leeb4r1qy96s.cloudfront.net/assets/star_5px.png" alt="*" />
              </span>
          ...
          <dd>
            ...
            <div className={styles.applicationFieldInputClass}>
              <textarea name="hobby" rows={4} value={formData.hobby} onChange={handleChange} autoComplete="off" />
            </div>
          </dd>
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="font-normal normal-case" htmlFor="job_contact">
                Та манай компанийн талаарх мэдээллийг ямар эх сурвалжаас олж мэдсэн болох
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <input
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="font-normal normal-case" htmlFor="wish_message">
                Та Barloworld Mongolia LLC компанид яагаад ажиллах хүсэлтэй байгаа болох
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <input
        ...
        <dl>
          <dt className={styles.gnewtonSectionTitleClass}>Гэр бүлийн гишүүдийн талаарх мэдээлэл</dt>
          {familyMembers.map((member, index) => (
            <div key={index} className="flex ">
              <div className="flex-1 custom-section relative max-w-[480px]">
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`f${index + 1}_1`}>
                      Нэр
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`f${index + 1}_2`}>
                      Регистрийн дугаар
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`f${index + 1}_3`}>
                      Нас
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`f${index + 1}_4`}>
                      Таны хэн болох
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`f${index + 1}_5`}>
                      Утасны дугаар
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                <dd>
                  <div className={styles.applicationQuestionLabelClass}>
                    <label className="font-normal normal-case" htmlFor={`f${index + 1}_6`}>
                      Ажил эрхлэлт
                    </label>
                    {index === 0 && (
                      <span className="gnewtonStar">
                ...
                {index != 0 && (
                  <button className="float-right" type="button" onClick={() => removeEntry("family", index)}>
                    <Image
                      src="https://d3leeb4r1qy96s.cloudfront.net/assets/img/delete-icon.svg"
                      width={28}
                      height={28}
        ...
        <dl>
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="capitalize" htmlFor="pain">
                1.Таныг ажлаа хийхэд эрсдэлд оруулж болзошгүй эрүүл мэндийн асуудал (архаг өвчин, харшил гэх мэт) байгаа
                юу?
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <select id="pain" name="pain" title="Pain" value={formData.pain} onChange={handleChange} required>
                <option value="">-</option>
                <option value="Тийм">Тийм</option>
                <option value="Үгүй">Үгүй</option>
              </select>
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="capitalize" htmlFor="friend_in_job">
                2. Танд тус компанид ажилладаг Барловорлд ашиг сонирхлын зөрчлийн бодлогод тодорхойлсон "Найз" эсвэл
                "дотны гэр бүлийн гишүүн" бий юу?
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <select
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="font-normal lowercase" htmlFor="friend_in_job_text">
                <b>3. Танд тус компанид ажилладаг гэр бүлийн гишүүн, хамаатан садан болон/эсвэл дотны найз бий юу?</b>{" "}
                (Гэр бүлийн гишүүний тодорхойлолт: эхнэр, нөхөр, хамтран амьдрагч хүүхдүүд, эцэг эх, ах эгч нар, хадам
                ээж, хадам аав, хадам ах, эгч, нагац, авга ба/эсвэл зээ дүү.
                <br />
                <b>Найзын тодорхойлолт:</b> ажилтны хамт олонд танил тал, найз нөхөд, ажилтны гэр бүлийн найз, ажил
                хэргийн болон мэргэжлийн нийтлэг ашиг сонирхол бүхий хамтран зүтгэгч ба/эсвэл "Гэр бүлийн гишүүн" гэсэн
                тодорхойлолтод ороогүй ураг төрөл.) Хэрэв Тийм гэж зурсан бол нэрийг нь бичнэ үү.
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <input
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="capitalize" htmlFor="biznes_travel">
                5.Богино хугацаанд болон хэд хэдэн бизнес аяллаар явахад бэлэн эсэх
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <select
          ...
          <dd>
            <div className={styles.applicationQuestionLabelClass}>
              <label className="capitalize" htmlFor="reasonSelect">
                6. Ажлын тусгай нөхцөл төлөвлөх шаардлагатай эсэх (Жишээ нь: Чөлөөний өдрөө нэмэгдүүлэх, богиносгосон
                цагаар ажиллах, хагас цагаар ажиллах гэх мэт)
              </label>
            </div>
            <div className={styles.applicationFieldInputClass}>
              <select id="reasonSelect" name="reasonSelect" title="reasonSelect" onChange={handleSelectedReasonChange}>
                <option>-</option>
                <option value="Тийм">Тийм</option>
                <option value="Үгүй">Үгүй</option>
              </select>
        ...
        <div className="">
          <div className="mb-4">
            <button
              type="submit"
              className={`rounded-sm h-10 leading-10 cursor-pointer w-28 text-white ${
                isNextDisabled ? "bg-[#ccd3d8]" : "bg-[#3498db]"
              }`}
              onClick={submitForm}
          ...
          <div>
            <button type="button" className="text-[#666] text-sm hover:text-[#4e4d4d]" onClick={() => router.back()}>
              Буцах
            </button>
          </div>
        </div>
