                ...
                <div className="masthead-background">
                    ...
                    <div className="masthead-dark-overlay">
                        <div className="masthead-overlay-left ">
                            <Image src={"/assets/img/masthead-graphic-left.png"} width={589} height={336} className="entered lazyloaded" />
                        </div>
                        <div className="masthead-overlay-right">
                            <Image src={"/assets/img/masthead-graphic-right.png"} width={589} height={336} className="entered lazyloaded" />
                        </div>
                        <span className="masthead-overlay-color"></span>
                    </div>
                    <div className="masthead-background-image">
                        <Image layout="fill" className=" entered lazyloaded" src={props?.image ? props?.image : ""} />
                    </div>
                </div>
