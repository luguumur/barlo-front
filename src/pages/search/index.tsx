...
const Search: InferGetServerSidePropsType<typeof getServerSideProps> = (props: any) => {
  ...
  return (
    <>
      <Head title={equipmentt(`equipmentSearch`)}></Head>
      <Nav />
      <PageHeader
        title={equipmentt(`equipmentSearch`)}
        image="https://d3leeb4r1qy96s.cloudfront.net/assets/img/cta-banner-image-1536x306.jpg"
      />
      <article
        className="page-body container position--relative min-h-[600px] post type-post status-publish format-standard has-post-thumbnail hentry category-events"
        id="page-body"
      >
        <div className="equipment-search-wrap">
          <div className="equipment-search-wrap--background soft push--bottom">
            <h5 className="js-equipment-search-title">
              Filter Your Search <span className="visible-xxs-inline-block push--left">▾</span>
            </h5>
                ...
                <div className="col-xs-6 col-md-12 push--bottom">
                  <div className="quick-search-options-box">
                    <input
                      ...
                      value="new"
                      id="new"
                      defaultChecked={props.condition === "new"}
                    />
                    ...
                    <input
                      ...
                      value="used"
                      id="used"
                      defaultChecked={props.condition === "used"}
                    />
              ...
              <div className="facetwp-template">
                {result.map((item: any, index: any) => (
                  <Link
                    ...
                    href={"/equipment/" + props.condition + "/" + item.category_id + "/" + item.id}
                  >
